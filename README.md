...
- The target specification, including username and hostname
-- __rsync-invoke.sh__ example: `root@boomer:/mnt/tank/foo`
-- __rsync-modlue.sh__ example: `root@boomer/tank/foo`
- A log filename
...
This is easier to explain with an example: to use the __rsync-invoke.sh__ to copy __foo__ to server 'BOOMER', use this command line:
